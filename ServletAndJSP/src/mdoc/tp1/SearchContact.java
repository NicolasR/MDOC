...
public class SearchContact extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
	      ...
	      Contact contact = daoContact.find((Long.parseLong((request.getParameter("id")))));
	      con.close();
	      ...
	      {	
	    	  ...
	    	  String urlargs = "id="+contact.getId()+"&firstname="+contact.getFirstName()
	    	  	+"&lastname="+contact.getLastName()+"&email="+contact.getEmail();
	    	  out.println("<a href='updateContact.jsp?"+urlargs+"'>Modifier</a>");
	      }
